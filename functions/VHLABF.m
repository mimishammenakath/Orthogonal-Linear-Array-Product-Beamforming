%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
% Vertical and Horizontal Linear Array Beamforming                       %                               
%  Parameters:                                                                                                                                %
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
function beamformed_data=VHLABF(Sensor_data_V,Sensor_data_H,timeVector,delay_V,delay_H,range_index)

InputParameters;

%% Proposed beamforming
beamformed_data_V=LABF(Sensor_data_V,timeVector,delay_V,range_index,N,Mb,Nb);
beamformed_data_H=LABF(Sensor_data_H,timeVector,delay_H,range_index,M,Mb,Nb);
