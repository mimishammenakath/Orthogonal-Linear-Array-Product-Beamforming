%-- Script for modelling an L shape underwater target in k-Wave 3D grid.
...
scattering_region1(500:550,20:40,20:200)=1;
scattering_region1(500:550,25:35,55:95)=0;
scattering_region1(500:550,25:35,135:165)=0;

scattering_region2= zeros(Nx,Ny,Nz);
scattering_region2(500:550,20:200,180:200)=1;
scattering_region2(500:550,55:95,185:195)=0;
scattering_region2(500:550,135:165,185:195)=0;
...
d=dx;
fc=source_f0;
scattering_region=permute(single(scattering_region1|scattering_region2),[2 3 1]);
save('L_shape','rawData','timeVector','fs','d','dx','fc','Nx','Ny','Nz','width_probe_geometry','length_probe_geometry','scattering_region');