...
tic
beamformed_data(1:ceil(Mb/2),1:ceil(Nb/2))=VHLABF_Farfield(Sensor_data_V1,Sensor_data_H1,timeVector,delay_V11,delay_H11,range_index);
toc
beamformed_data(ceil(Mb/2)+1:Mb,1:ceil(Nb/2))=VHLABF_Farfield(Sensor_data_V1,Sensor_data_H2,timeVector,delay_V12,delay_H22,range_index);
beamformed_data(1:ceil(Mb/2),ceil(Nb/2)+1:Nb)=VHLABF_Farfield(Sensor_data_V2,Sensor_data_H1,timeVector,delay_V23,delay_H13,range_index);
beamformed_data(ceil(Mb/2)+1:Mb,ceil(Nb/2)+1:Nb)=VHLABF_Farfield(Sensor_data_V2,Sensor_data_H2,timeVector,delay_V24,delay_H24,range_index);
